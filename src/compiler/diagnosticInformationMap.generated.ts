...
module ts {
    export var Diagnostics = {
        ...
        Type_declaration_expected: { code: 1219, category: DiagnosticCategory.Error, key: "Type declaration expected." },
        ...
        A_type_guard_function_can_only_return_a_boolean: { code: 1221, category: DiagnosticCategory.Error, key: "A type-guard function can only return a boolean." },
        Cannot_find_parameter_0: { code: 1222, category: DiagnosticCategory.Error, key: "Cannot find parameter '{0}'." },
        Type_guard_annotation_0_is_not_assignable_to_1: { code: 1223, category: DiagnosticCategory.Error, key: "Type-guard annotation '{0}' is not assignable to '{1}'." },
        Parameter_index_from_0_does_not_match_the_parameter_index_from_1: { code: 1224, category: DiagnosticCategory.Error, key: "Parameter index from '{0}' does not match the parameter index from '{1}'." },
